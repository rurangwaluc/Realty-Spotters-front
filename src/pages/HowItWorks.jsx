      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-sm sm:text-base text-slate-600">
            Fast, human-centered, and data-driven — we surface Kigali neighborhoods
            ...
            <div className="sticky top-24 rounded-2xl bg-slate-50 p-6 sm:p-7 shadow-inner border border-slate-200">
              ...
              <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="rounded-xl bg-white p-4 shadow-sm border border-slate-200">
                  <div className="text-xs font-medium text-slate-500">Free</div>
                ...
                <div className="rounded-xl bg-white p-4 shadow-sm border border-slate-200">
                  <div className="text-xs font-medium text-slate-500">Unlocked</div>
                  <div className="mt-1 text-sm font-semibold text-slate-900">
