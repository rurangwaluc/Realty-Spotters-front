...
export default function Info() {
  return (
    <>
      <Helmet>
        <title>Help & Information | Realty Spotters</title>
        <meta
          name="description"
          content="Get help with payments, pricing, and how Realty Spotters works. Learn about one-time payments, MTN MoMo, refunds, and support."
        />
      </Helmet>
