          ...
          <section className="order-2 md:order-1">
            <div className="max-w-xl">
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold leading-tight text-gray-900">
                Need help finding home? <span className="bg-clip-text text-transparent bg-gradient-to-r from-slate-800 to-amber-400">Realty Spotters</span> has your back.
              </h1>
              ...
              <div className="mt-6 flex flex-col sm:flex-row sm:items-center sm:gap-4 gap-3">
                <a href="/search" className="inline-flex items-center justify-center px-4 py-2 bg-slate-800 hover:bg-slate-900 text-white rounded-lg text-sm font-medium shadow-sm">
            ...
            <div className="mt-8 md:mt-12 hidden sm:block">
              <div className="rounded-xl bg-white/60 backdrop-blur-sm p-4 shadow-md inline-flex items-center gap-4">
                <svg className="w-8 h-8 text-slate-800" viewBox="0 0 24 24" fill="none" aria-hidden><path d="M12 2L2 7l10 5 10-5-10-5z" fill="currentColor"/></svg>
                <div>
              ...
              <div className="mt-4 pt-4 border-t border-gray-100 text-sm text-gray-500">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <svg className="w-4 h-4 text-amber-500" viewBox="0 0 24 24" fill="none" aria-hidden><path d="M5 13l4 4L19 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
